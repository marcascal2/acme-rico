...
public class ClientRegisterUITest {
  ...
  public void testClientRegisterUI() throws Exception {
    ...
    driver.findElement(By.name("dniFile")).click();
    driver.findElement(By.name("dniFile")).clear();
    driver.findElement(By.name("dniFile")).sendKeys("C:\\Users\\Javier\\Pictures\\629642.jpg");
