	...
	<div class="container">
		...
		<sec:authorize access="hasAuthority('worker')">
			<petclinic:menuItem active="${name eq 'clients'}" url="/clients/find"
				title="find clients">
				<span class="glyphicon glyphicon-search" aria-hidden="tru
				e"></span>
				<span>Clients</span>
			</petclinic:menuItem>
			<li class="nav-item dropdown" id="clients-requests"><a
				class="nav-link dropdown-toggle" id="dropdown-workers" role="button"
				data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			...
			<sec:authorize access="isAuthenticated()">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"> <span class="glyphicon glyphicon-user"></span>
						<strong id="username"><sec:authentication property="name" /></strong> <span
