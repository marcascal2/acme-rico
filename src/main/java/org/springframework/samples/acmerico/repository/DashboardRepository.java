...
public interface DashboardRepository extends CrudRepository<User, Integer> {
	...
	Integer countLoanAppsAccepted(@Param("client") Client client);
	...
	Integer countLoanAppsPending(@Param("client") Client client);
	...
	Integer countLoanAppsRejected(@Param("client") Client client);
	...
	Integer countCreditCardAppsAccepted(@Param("client") Client client);
	...
	Integer countCreditCardAppsPending(@Param("client") Client client);
	...
	Integer countCreditCardAppsRejected(@Param("client") Client client);
	...
	Integer countTransferAppsAccepted(@Param("client") Client client);
	...
	Integer countTransferAppsPending(@Param("client") Client client);
