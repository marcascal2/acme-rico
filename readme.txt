DECISIONES MÁS SIGNIFICATIVAS:
	...
	1. APIS:
		...
		- En cuanto a la incorporación de un metodo get, con la API de ExchangeRate, no supuso al principio mayor dificultad, aunque a la hora de realizar los tests 
